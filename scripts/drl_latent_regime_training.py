...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", type=str, default="data/baselines/drl_latent_regime")
    parser.add_argument(
        "--transformer-root",
        type=str,
    ...
    parser.add_argument(
        ...
        help="Transformer latent variant to use. Default all runs every variant sequentially.",
    )
    parser.add_argument(
        "--regime-root",
        type=str,
    ...
    parser.add_argument(
        ...
        type=int,
        default=25_000,
        help="Print TDQN learn() progress every N timesteps; use 0 to disable.",
    )
...
def main() -> None:
    args = parse_args()
    variants = ["gating", "no_gating", "no_sentiment"] if args.variant == "all" else [args.variant]
    for variant in variants:
        ...
        print(f"TDQN latent+regime complete for {variant}. Metrics:")
